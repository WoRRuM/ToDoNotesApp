...
fun ExistingTaskAppBarActions(
    ...
    DisplayAlertDialog(
        title = stringResource(
            id = R.string.delete_task, selectedTask.title
        ),
        message = stringResource(
            id = R.string.delete_task_conformation, selectedTask.title
        ),
...
@Composable
@Preview
fun ExistingAppBarTaskPreview() {
    ExistingTaskAppBar(
        selectedTask = ToDoTask(
            0, "Yury", "Some random text", priority = Priority.LOW
        ),
